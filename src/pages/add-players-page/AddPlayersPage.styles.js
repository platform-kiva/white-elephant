...
export const PlayerItem = styled(motion.div)`
    background: ${props =>  props.$isDuplicate ? 'rgba(255,0,55,0.25)' :'rgba(255,255,255,0.25)'};
    border: ${props => props.$isDuplicate ? '2px solid rgba(255,0,120,0.55)' : '2px solid rgba(255,255,255,0.25)'};
    box-sizing: border-box;
    color: #FFFFFF;
    display: flex;
